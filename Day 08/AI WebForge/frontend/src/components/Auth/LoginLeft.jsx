  ...
  return (
    <div className="hidden lg:flex lg:w-2/5 bg-[url('/bg-img.png')] bg-cover bg-center bg-no-repeat flex-col justify-between p-12  shrink-0 select-none">
      <div className=" flex items-center gap-3">
        ...
        <span className="text-4xl font-medium text-white">Ai WebForge</span>
      </div>
      <div>
        <h2 className="text-white leading-snug mb-3 tracking-tight text-4xl font-medium">
          Build Your presence of web
        </h2>
        ...
        <p className="text-zinc-300 text-sm mt-12">
          Copyright {new Date().getFullYear()} AI WebForge{" "}
        </p>
      </div>
    </div>
  );
